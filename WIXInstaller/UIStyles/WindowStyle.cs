...
namespace Template.Styles.WindowStyle
{
    ...
    public partial class WindowStyle
    {
        ...
        {
            MessageBoxResult dialogResult = MessageBox.Show("Are you want to close?", "Closing", MessageBoxButton.YesNo, MessageBoxImage.Question);
            switch (dialogResult)
            {
                case MessageBoxResult.Yes: sender.ForWindowFromTemplate(w => w.Close()); break;
        ...
        void ChangeColorClick(object sender, RoutedEventArgs e)
        {
            ...
            Rectangle r = (Rectangle)b.Content;
            if (r.Fill == (Brush)Application.Current.MainWindow.FindResource("LightBaseColor"))
            {
                r.Fill = (Brush)Application.Current.MainWindow.FindResource("DarkBaseColor");
            }
            else
            {
                r.Fill = (Brush)Application.Current.MainWindow.FindResource("LightBaseColor");
            }
        }
        #endregion
